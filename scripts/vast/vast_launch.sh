...
export LORA_CAPS='${LORA_CAPS:-}'
export RL_OUT='${RL_OUT:-runs/rl/search-v1}'
export RL_STEPS='${RL_STEPS:-150}'
export RL_GROUP='${RL_GROUP:-8}'
export RL_QPS='${RL_QPS:-16}'
export RL_MAX_TOKENS='${RL_MAX_TOKENS:-160}'
export RL_QUESTIONS='${RL_QUESTIONS:-4000}'
export RL_ADAPTER='${RL_ADAPTER:-}'
export RL_PUSH_REPO='${RL_PUSH_REPO:-}'
